...
import { FaHtml5, FaReact, FaCss3, FaVuejs, FaPython, FaGithub } from 'react-icons/fa'
  ...
  return (
    <div className='flex flex-col w-full lg:max-w-2xl lg:px-6 py-5'>
        <div className='flex items-center gap-2 mb-2'> 
            ...
            <h2 className='text-sm font-mukta font-semibold text-neutral-900 dark:text-neutral-300'>Archive for your application</h2>
        ...
        <div className='flex flex-col gap-4'>
            ...
            <p className='font-openSans text-neutral-700 dark:text-neutral-300'>
        ...
        <div className='mt-5 flex flex-wrap gap-4'>
          {welcomeTechnology.map((tech, index) => (
            <div key={index} className='flex items-center gap-2 font-openSans font-medium text-xs lg:text-sm bg-neutral-100 dark:bg-neutral-900 w-fit p-2 lg:p-3 rounded-full text-neutral-600 dark:text-neutral-400'>
